...
def main(height):
    ...
    # Convert to wo
    components = create_mass_percents_dictionary(mat)
    ...
    mat.cross_sections='/home/oleg/projects/cross-section-libraries/endfb71_h5/cross_sections.xml'
