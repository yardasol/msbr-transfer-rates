...
def main(height):
    ...
    b4c = openmc.Material(name='absorber')
    b4c.set_density('g/cm3', 2.50)
    #b4c.add_element('B', 4)
    #b4c.add_element('C', 1)
    b4c.add_elements_from_formula('B4C')

    mat = openmc.Materials(materials=[fuel, moder, hast, b4c])
    mat.cross_sections='/home/yardasol/projects/cross-section-libraries/endfb71_h5/cross_sections.xml'
